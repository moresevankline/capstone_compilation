...
List<String> frappePicksList = [
  "CHEESECAKE",
  "MOCHA",
  "MACHA",
];

final List<Widget> frappePicks = frappePicksList
    .map(
      (item) => Column(
...
class Frappe extends StatefulWidget {
  const Frappe({super.key});

  @override
  State<Frappe> createState() => _FrappeState();
}

class _FrappeState extends State<Frappe> {
  int _current = 0;
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: frappePicks.asMap().entries.map(
                        (entry) {
