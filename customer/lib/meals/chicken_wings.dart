...
List<String> chickenWingsPicksList = [
  "BUFFALO",
  "SALTED EGG",
  "HONEY BUTTER & GARLIC",
];

final List<Widget> chickenWingsPicks = chickenWingsPicksList
    .map(
      (item) => Column(
...
class ChickenWings extends StatefulWidget {
  const ChickenWings({super.key});

  @override
  State<ChickenWings> createState() => _ChickenWingsState();
}

class _ChickenWingsState extends State<ChickenWings> {
  int _current = 0;
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: chickenWingsPicks.asMap().entries.map(
                        (entry) {
