...
List<String> lightBitesPicksList = [
  "FRIES",
  "SPICY WEDGES",
  "NACHOS",
];

final List<Widget> lightBitesPicks = lightBitesPicksList
    .map(
      (item) => Column(
...
class LightBites extends StatefulWidget {
  const LightBites({super.key});

  @override
  State<LightBites> createState() => _LightBitesState();
}

class _LightBitesState extends State<LightBites> {
  int _current = 0;
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: lightBitesPicks.asMap().entries.map(
                        (entry) {
