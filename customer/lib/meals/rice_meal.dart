...
List<String> riceMealPicksList = [
  "CHICKEN CHOPS",
  "BAGNET W/ RICE",
  "PORK STEAK",
];

final List<Widget> riceMealPicks = riceMealPicksList
    .map(
      (item) => Column(
...
class RiceMeal extends StatefulWidget {
  const RiceMeal({super.key});

  @override
  State<RiceMeal> createState() => _RiceMealState();
}

class _RiceMealState extends State<RiceMeal> {
  int _current = 0;
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: riceMealPicks.asMap().entries.map(
                        (entry) {
