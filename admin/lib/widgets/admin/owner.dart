...
class OwnerRegistrationDialog extends StatefulWidget {
  const OwnerRegistrationDialog({super.key});

  @override
  OwnerRegistrationDialogState createState() => OwnerRegistrationDialogState();
}

class OwnerRegistrationDialogState extends State<OwnerRegistrationDialog> {
